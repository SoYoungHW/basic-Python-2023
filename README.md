...
1. 파이썬 응용
    - 라이브러리 사용법
        - urllib.request
     - 웹 크롤링 [소스](https://github.com/SoYoungHW/studyPython2023/blob/main/Day08/code44_web_crawling_tutorial.ipynb)(기초)
        - 기상청 오늘의 날씨 크롤링
        - 데이터포털 OpenAPI 크롤링
        - BeautifulSoup 크롤링
...
![실행화면](https://raw.githubusercontent.com/SoYoungHW/studyPython2023/main/images/dialog.png)
